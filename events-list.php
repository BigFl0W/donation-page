                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-sm-1">
                    <div class="col mb-5">
                        <div class="event-wrap">
                            <!-- Event Wrap -->
                            <div class="img-wrap">
                                <a href="events-single.php"><img src="assets/images/events/event_img_1.jpg" alt=""></a>
                            </div>
                            ...
                            <div class="text-md-end read-more-wrap">
                                <a href="events-single.php" class="read-more-line"><span>Read More</span></a>
                            </div>
                            <!-- Event Wrap -->
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="event-wrap">
                            <!-- Event Wrap -->
                            <div class="img-wrap">
                                <a href="events-single.php"><img src="assets/images/events/event_img_2.jpg" alt=""></a>
                            </div>
                            <div class="content-wrap">
                                <div class="date-wrap d-lg-flex align-items-end">
                                    <div class="date-box">
                                ...
                                <h3><a href="events-single.php">If you don’t help feed them, who will? Help the many people in need.</a></h3>
                            </div>
                            <div class="text-md-end read-more-wrap">
                                <a href="events-single.php" class="read-more-line"><span>Read More</span></a>
                            </div>
                    ...
                    <div class="col mb-5">
                        <div class="event-wrap">
                            <!-- Event Wrap -->
                            <div class="img-wrap">
                                <a href="events-single.php"><img src="assets/images/events/event_img_3.jpg" alt=""></a>
                            </div>
                            <div class="content-wrap">
                                <div class="date-wrap d-lg-flex align-items-end">
                                    <div class="date-box">
                    ...
                    <div class="col mb-5">
                        <div class="event-wrap">
                            <!-- Event Wrap -->
                            <div class="img-wrap">
                                <a href="events-single.php"><img src="assets/images/events/event_img_4.jpg" alt=""></a>
                            </div>
                            <div class="content-wrap">
                                <div class="date-wrap d-lg-flex align-items-end">
                                    <div class="date-box">
                    ...
                    <div class="col mb-5">
                        <div class="event-wrap">
                            <!-- Event Wrap -->
                            <div class="img-wrap">
                                <a href="events-single.php"><img src="assets/images/events/event_img_5.jpg" alt=""></a>
                            </div>
                            <div class="content-wrap">
                                <div class="date-wrap d-lg-flex align-items-end">
                                    <div class="date-box">
                    ...
                    <div class="col mb-5">
                        <div class="event-wrap">
                            <!-- Event Wrap -->
                            <div class="img-wrap">
                                <a href="events-single.php"><img src="assets/images/events/event_img_6.jpg" alt=""></a>
                            </div>
                            <div class="content-wrap">
                                <div class="date-wrap d-lg-flex align-items-end">
                                    <div class="date-box">
                        ...
                        <ul class="pagination justify-content-center">
                            <li class="page-item disabled">
                                <a class="page-link" href="#" aria-label="Previous">
                                    <span aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-left"><polyline points="15 18 9 12 15 6"></polyline></svg></span>
                                </a>
                            </li>
                            ...
                            <li class="page-item">
                                <a class="page-link" href="#" aria-label="Next">
                                    <span aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg></span>
                                </a>
                            </li>
                        </ul>
                    </nav>
                    ...
                    <div class="footer-widget-contact">
                        <ul class="list-unstyled">
                            ...
                            <li>
                                ...
                                <div><a href="/cdn-cgi/l/email-protection#87eee9e1e8c7efe8f7e2f5e6eef4e2a9e4e8ea"><span class="__cf_email__" data-cfemail="d2bbbcb4bd92babda2b7a0b3bba1b7fcb1bdbf">[email&#160;protected]</span></a></div>
                            </li>
                            <li>
