                                ...
                                <div class="content-wrap-single">
                                    <div class="featured-cause-timer">
                                        ...
                                        <div class="d-md-flex align-items-end justify-content-between">
                                            ...
                                            <a class="btn-outline-default btn" href="donation-page.php">Donate Now</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form class="comment-form">
                                ...
                                <div class="d-md-flex justify-content-between align-items-center mt-3">
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="inlineCheckbox2">Save my name, email, and website in this browser for the next
                            ...
                            <div class="sidebar-primary col-lg-12 col-md-6">
                                ...
                                <div class="widget-wrap">
                                    ...
                                    <div class="causes-wrap">
                                        ...
                                        <div class="content-wrap">
                                            ...
                                            <div class="text-md-end">
                                                <a href="causes-single.php" class="read-more-line"><span>Read More</span></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="causes-wrap">
                                        ...
                                        <div class="content-wrap">
                                            <span class="tag">Health</span>
                                            <h3><a href="causes-single.php">Help From Natural
                                                Disaster</a></h3>
                                            <div class="text-md-end">
                                                <a href="causes-single.php" class="read-more-line"><span>Read More</span></a>
                                            </div>
                            ...
                            <div class="sidebar-secondary col-lg-12 col-md-6">
                                ...
                                <div class="widget-wrap">
                                    ...
                                    <div class="our-donators">
                                        ...
                                        <a href="donation-page.php" class="btn-block btn btn-default">Become Donators</a>
                                    </div>
                                </div>
                                <!-- Widget Wrap -->
                    ...
                    <div class="footer-widget-contact">
                        <ul class="list-unstyled">
                            ...
                            <li>
                                ...
                                <div><a href="/cdn-cgi/l/email-protection#345d5a525b745c5b445146555d47511a575b59"><span class="__cf_email__" data-cfemail="bcd5d2dad3fcd4d3ccd9ceddd5cfd992dfd3d1">[email&#160;protected]</span></a></div>
                            </li>
                            <li>
