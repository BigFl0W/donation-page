                    ...
                    <div class="col-lg-8 col-md-7">
                        ...
                        <div class="theme-collapse">
                            ...
                            <div class="toggle">
                                <span class="icon">
                                    <i class="icofont-plus"></i>
                                </span> Whom do I contact if I wish to volunteer?
                            </div>
                            <!-- Toggle Links 2 -->
                            ...
                            <div class="toggle">
                                <span class="icon">
                                    <i class="icofont-plus"></i>
                                </span> Will my contributions be appreciated?
                            </div>
                            <!-- Toggle Links 3 -->
                            ...
                            <div class="toggle">
                                <span class="icon">
                                    <i class="icofont-plus"></i>
                                </span> Who do I contact for press related inquaries?
                            </div>
                            <!-- Toggle Links 4 -->
                            ...
                            <div class="toggle">
                                <span class="icon">
                                    <i class="icofont-plus"></i>
                                </span> How do I include a beneficiary of my will or trust?
                            </div>
                            <!-- Toggle Links 5 -->
                    ...
                    <div class="footer-widget-contact">
                        <ul class="list-unstyled">
                            ...
                            <li>
                                ...
                                <div><a href="/cdn-cgi/l/email-protection#9cf5f2faf3dcf4f3ecf9eefdf5eff9b2fff3f1"><span class="__cf_email__" data-cfemail="5a33343c351a32352a3f283b33293f74393537">[email&#160;protected]</span></a></div>
                            </li>
                            <li>
