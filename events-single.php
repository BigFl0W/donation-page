        ...
        <section class="wide-tb-100">
            <div class="container">
                ...
                <div class="events-single-img">
                    <img src="assets/images/events/event_single_large.jpg" alt="">                    
                </div>
            </div>
                            ...
                            <div class="event-single-listing pattern-orange">
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        ...
                                        <div>Orion International</div>
                                    </li>
                                    <li>
                                        <div><i data-feather="phone"></i> </div>
                                        <div><a href="tel:02-235-235-2365">02-235-235-2365</a></div>
                                    </li>
                                    <li>
                                        <div><i data-feather="mail"></i> </div>
                                        <div><a href="/cdn-cgi/l/email-protection#6f260109002f001d060001410c0002"><span class="__cf_email__" data-cfemail="f0b99e969fb09f82999f9ede939f9d">[email&#160;protected]</span></a></div>
                                    </li>
                                    <li>
                                        <div><i data-feather="globe"></i> </div>
                                        <div><a href="#">www.orionin.com</a></div>
                                    </li>                                    
                                </ul>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="footer-widget-contact">
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <div><i data-feather="mail"></i> </div>
                                <div><a href="/cdn-cgi/l/email-protection#6b02050d042b03041b0e190a02180e45080406"><span class="__cf_email__" data-cfemail="1871767e77587077687d6a79716b7d367b7775">[email&#160;protected]</span></a></div>
                            </li>
                            <li>
                                <div><i data-feather="clock"></i> </div>
