...
<body>
    ...
    <main id="body-content">
        ...
        <section class="wide-tb-100 pb-0">
            <div class="container">
                <div class="row demo-btns">
                    ...
                    <div class="col-sm-12">
                        <h3 class="fw-7 txt-blue head-letter-spacing mb-4">Buttons Styles Default</h3>
                        <button type="button" class="mb-3 btn btn-default">Default</button>
                        <button type="button" class="mb-3 btn btn-primary">Primary</button>
                        <button type="button" class="mb-3 btn btn-secondary">Secondary</button>
                        <button type="button" class="mb-3 btn btn-success">Success</button>
                        <button type="button" class="mb-3 btn btn-danger">Danger</button>
                        <button type="button" class="mb-3 btn btn-warning">Warning</button>
                        <button type="button" class="mb-3 btn btn-info">Info</button>
                        <button type="button" class="mb-3 btn btn-light">Light</button>
                        <button type="button" class="mb-3 btn btn-dark">Dark</button>

                    </div>
        
                    <div class="col-sm-12 mt-4">
                        <h3 class="fw-7 txt-blue head-letter-spacing mb-4">Buttons Styles Outline</h3>
                        <button type="button" class="mb-3 btn btn-outline-default">Default</button>
                        <button type="button" class="mb-3 btn btn-outline-primary">Primary</button>
                        <button type="button" class="mb-3 btn btn-outline-secondary">Secondary</button>
                        <button type="button" class="mb-3 btn btn-outline-success">Success</button>
                        <button type="button" class="mb-3 btn btn-outline-danger">Danger</button>
                        <button type="button" class="mb-3 btn btn-outline-warning">Warning</button>
                        <button type="button" class="mb-3 btn btn-outline-info">Info</button>
                        <button type="button" class="mb-3 btn btn-outline-light">Light</button>
                        <button type="button" class="mb-3 btn btn-outline-dark">Dark</button>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- Accordian & Tabbing Style Start -->
        <section class="wide-tb-100 pb-0">
          <div class="container">
            <div class="row">
                <div class="col-sm-12">
                  <h3 class="fw-7 txt-blue mb-4">Accordions & Tabs</h3>
                </div>
                <!-- Accordian Style -->
                <div class="col-md-6">
                ...
                <!-- Theme Tabbing Style -->
                <div class="col-md-6">
                    <ul class="nav nav-pills light theme-tabbing mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Mission</a>
                        </li>
                        <li class="nav-item">
        ...
        <section class="wide-tb-100 pb-0">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                      <h3 class="fw-7 txt-blue mb-4">Icon Boxes</h3>
                    </div>
                    ...
                    <!-- Icon Boxes 1 Style -->
                    <div class="col col-12 col-lg-4 col-md-6 mx-auto ">
                        <div class="icon-box-1">
                ...
                <div class="row mt-5">
                    ...
                    <!-- Icon Boxes Four Style -->
                    <div class="col col-12 col-lg-4 col-md-6 mx-auto">
                        <div class="icon-box-4 bg-gray">
                            <i data-feather="mail"></i>
                            <h3>Email Address</h3>
                            <div><a href="/cdn-cgi/l/email-protection#6e070008012e06011e0b1c0f071d0b400d0103"><span class="__cf_email__" data-cfemail="8de4e3ebe2cde5e2fde8ffece4fee8a3eee2e0">[email&#160;protected]</span></a></div>
                            <div><a href="/cdn-cgi/l/email-protection#87f1e8ebf2e9f3e2e2f5c7efe8f7e2f5e6eef4e2a9e4e8ea"><span class="__cf_email__" data-cfemail="54223b38213a20313126143c3b243126353d27317a373b39">[email&#160;protected]</span></a></div>
                        </div>
                    </div>
                    <!-- Icon Boxes Four Style -->
                </div>
        ...
        <div class="container wide-tb-80 pb-0">
            <div class="row">          
                <div class="col-sm-12">
                    <h3 class="fw-7 txt-blue mb-4">Counters</h3>
                </div>          
            </div>
        </div>

        <!-- Counter Style Box -->
        <section class="pattern-green wide-tb-100 counter-map">
            <div class="container">
        ...
        <section class="wide-tb-100 bg-fixed bg-img-7 pos-rel">
                ...
                <div class="row">
                    ...
                    <div class="col col-12 col-md-4">
                        <div class="counter-style-box bg-dark-shade bg-green">
                            <div class="counter-txt"><span class="counter">180</span>+</div>
                            <div>Fundraising & Donation Campaign </div>
                        </div>
                    </div>
                    <!-- Counter Col End -->
                    ...
                    <div class="col col-12 col-md-4">
                        <div class="counter-style-box bg-dark-shade bg-orange">               
                            <div class="counter-txt"><span class="counter">7120</span>+</div>
                            <div>Success Full Project Complate</div>
                        </div>
                    </div>
                    <!-- Counter Col End -->
                    ...
                    <div class="col col-12 col-md-4">
                        <div class="counter-style-box">
                            <div class="counter-txt"><span class="counter">250</span>+</div>
                            <div>Award Winning Campaign</div>
                        </div>
                    </div>
                    <!-- Counter Col End -->
                </div>
            ...
            <div class="container">
                <div class="row">          
                    <div class="col-sm-12 mb-0">
                        <h3 class="fw-7 txt-blue head-letter-spacing mb-4">Callout Section</h3>
                    </div>

                    <!-- Callout Section Side Image -->
                    <div class="col-sm-12">
                        <div class="callout-style-side-img d-lg-flex align-items-center top-broken-grid m-0">
        ...
        <section class="wide-tb-100">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 mb-0">
                        <h3 class="fw-7 txt-blue head-letter-spacing mb-4">Skills Bar</h3>
                    </div>
                    ...
                    <div class="footer-widget-contact">
                        <ul class="list-unstyled">
                            ...
                            <li>
                                ...
                                <div><a href="/cdn-cgi/l/email-protection#335a5d555c735b5c435641525a40561d505c5e"><span class="__cf_email__" data-cfemail="fe97909891be96918e9b8c9f978d9bd09d9193">[email&#160;protected]</span></a></div>
                            </li>
                            <li>
