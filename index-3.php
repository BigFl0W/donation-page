                    ...
                    <div class="col-lg-5 col-md-12">
                        ...
                        <div class="mt-3">
                            <ul class="list-unstyled icons-listing theme-orange mb-0">
                                <li>Position:  Founder of Company</li>
                                <li>Expertise: Gardening, Lanscaping, Floristic</li>
                                <li>Experience: 15 Years</li>
                                <li>E-mail: <a href="/cdn-cgi/l/email-protection#2e5a414057005c414a5c47494b5d6e49434f4742004d4143"><span class="__cf_email__" data-cfemail="93e7fcfdeabde1fcf7e1faf4f6e0d3f4fef2faffbdf0fcfe">[email&#160;protected]</span></a></li>
                                <li>Phone: <a href="tel:5074521254">507-452-1254</a></li>
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-12 mb-0">
                                <h3 class="fw-7 txt-blue head-letter-spacing mb-4">Adams Hobes Skills</h3>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12 mb-0">
                                <div class="skillbar-wrap">
                                    ...
                                    <div class="skillbar" data-percent="85%">
                                        ...
                                        <div class="skillbar-bar" style="width: 84.9991%; overflow: hidden;"></div>
                                    </div>             
                                </div>
                            </div>
                            <!-- Animated Skillbars Start -->
                            ...
                            <div class="col-md-6 col-sm-12 mb-0">
                                <div class="skillbar-wrap">
                                    ...
                                    <div class="skillbar" data-percent="95%">
                                        ...
                                        <div class="skillbar-bar" style="width: 95.0005%; overflow: hidden;"></div>
                                    </div>             
                                </div>
                            </div>
                            <!-- Animated Skillbars Start -->
                            ...
                            <div class="col-md-6 col-sm-12 mb-0">
                                <div class="skillbar-wrap">
                                    ...
                                    <div class="skillbar" data-percent="75%">
                                        ...
                                        <div class="skillbar-bar" style="width: 75%; overflow: hidden;"></div>
                                    </div>             
                                </div>
                            </div>
                            <!-- Animated Skillbars Start -->
                    ...
                    <div class="footer-widget-contact">
                        <ul class="list-unstyled">
                            ...
                            <li>
                                ...
                                <div><a href="/cdn-cgi/l/email-protection#620b0c040d220a0d120710030b11074c010d0f"><span class="__cf_email__" data-cfemail="1871767e77587077687d6a79716b7d367b7775">[email&#160;protected]</span></a></div>
                            </li>
                            <li>
